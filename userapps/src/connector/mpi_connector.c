...
#endif
#if defined(CONFIG_MPP_DSI_ENABLE_LCD_ST7102)
    {
        // this configure is generated by tools.
        .connector_name = "st7102", // maybe should change it
        .screen_test_mode = 0,
        .dsi_test_mode = 0,
        .bg_color = BACKGROUND_BLACK_COLOR,
        .intr_line = 10, // 1024 lines
        ...
        .resolution = {
            .pclk = 39600, // 39600 * 1000 / (480 + 8 + 40 + 40) / (640 + 200 + 10 + 260) = 62.81 fps
            .phyclk = 475200,
            .htotal = (480 + 8 + 40 + 40), // 568
            .hdisplay = 480,
            .hsync_len = 8,
            .hback_porch = 40,
            .hfront_porch = 40,
            .vtotal = (640 + 200 + 10 + 260), // 1110
            .vdisplay = 640,
            .vsync_len = 200,
            .vback_porch = 10,
            .vfront_porch = 260,
        },
        .type = ST7102_MIPI_2LAN_480X640_60FPS, // maybe should change it
    },
#endif
