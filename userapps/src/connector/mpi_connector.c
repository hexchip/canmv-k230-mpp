...
k_connector_info connector_info_list[] = {
...
#endif
    {
        ...
        K_VO_LP_MODE,
        { 15, 295, 0x09, 0x96 },
        {148500, 890666, 1240, 1080, 20, 20, 120, 1988, 1920, 5, 8, 55},
    ...
    },
    {
        ...
        K_VO_LP_MODE,
        { 15, 295, 0x17, 0x96 },
        { 74250, 445500, 908, 800, 8, 48, 52, 1392, 1280, 6, 16, 100 },
        ILI9881_MIPI_4LAN_800X1280_60FPS,
    },
    {
        // this configure is generated by tools.
        ...
        .resolution = {
            ...
            .hback_porch = 20,
            .hfront_porch = 20,
            .vtotal = (960 + 10 + 20 + 110), // 980    = (vdisplay + vback_porch + vsync_len + vfront_porch)    
            .vdisplay = 960,
            .vsync_len = 10,
            .vback_porch = 20,
            .vfront_porch = 110,
